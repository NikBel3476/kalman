                                                          ...
                                                          m_login_button(new QPushButton())
{
  ...
  m_username_input->setSizePolicy(QSizePolicy(QSizePolicy::Expanding, QSizePolicy::Fixed));
  ...
  m_password_input->setSizePolicy(QSizePolicy(QSizePolicy::Expanding, QSizePolicy::Fixed));
  ...
  m_login_button->setSizePolicy(QSizePolicy(QSizePolicy::Expanding, QSizePolicy::Fixed));
  m_login_button->setMinimumWidth(MIN_FORM_WIDTH);
  m_login_button->setMaximumWidth(MAX_FORM_WIDTH);

  connect(m_login_button, &QPushButton::pressed, this, &AuthenticationForm::handleLoginButtonPress);
  connect(m_username_input, &QLineEdit::textChanged, this, &AuthenticationForm::handleUsernameChange);
  connect(m_password_input, &QLineEdit::textChanged, this, &AuthenticationForm::handlePasswordChange);
}
